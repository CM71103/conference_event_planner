...
import {toggleMealSelection} from './mealSlice.jsx'
...
const ConferenceEvent = () => {
    ...
    const handleMealSelection = (index) => {
        ...
        if(item.selected){
            const newPeople = item.selected ? numberOfPeople:0;
            dispatch(toggleMealSelection(index,newPeople))
        }
        else{
        ...
        if (section === "venue") {
          venueItems.forEach((item) => {
            ...
            mealsItem.forEach((item)=>{
                totalCost+=item.price*numberOfPeople;
            })
        }
        return totalCost;
      };
                                ...
                                <div className="input-container venue_selection">
                                    ...
                                    <input type="number" className="input_box5" id="numberOfPeople" value={numberOfPeople}
                                        onChange={(e)=>{
                                            ...
                                            if(isNaN(items) || value<1){
                                                setNumberOfPeople(1);
                                            }
                                            else{
                                                setNumberOfPeople(items);
                                            }
                                        }}
                                   min="1" ></input>
                                </div>
                                <div className="meal_selection">
                                    {mealsItems.map((item,index)=>(
                                        <div className="meal_item" key={index} style={{padding:15}}>
                                            ...
                                            {/* htmlFor is used to connect a lable with input elt */}
                                        </div>
                                    ))}
                                </div>
